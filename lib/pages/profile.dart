...
import 'package:stud_app/pages/edit_profile.dart';
import 'package:stud_app/pages/welcome.dart';
import 'package:stud_app/services/app_service.dart';
import 'package:stud_app/widgets/language.dart';
    ...
    return Scaffold(
        ...
        body: ListView(
          ...
          children: [
            ...
            //   onTap: () async => AppService().openLinkWithCustomTab(context, 'https://codecanyon.net/item/events-hour-flutter-events-app-with-admin-panel/25700781'),
            // ),
          ],
        ));
  }
