...
import 'package:stud_app/blocs/categories_bloc.dart';
import 'package:stud_app/models/category.dart';
import 'package:stud_app/pages/category_based_articles.dart';
import 'package:stud_app/utils/cached_image_with_dark.dart';
import 'package:stud_app/utils/empty.dart';
import 'package:stud_app/utils/loading_cards.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('events categories').tr(),
        elevation: 0,
        actions: <Widget>[
          IconButton(
            icon: Icon(
