...
import 'package:stud_app/widgets/full_image.dart';
import 'package:stud_app/widgets/iframe_player_widget.dart';
import 'package:stud_app/widgets/local_video_player.dart';
    ...
    return Html(
      ...
      style: {
        "body": Style(
          ...
          fontSize: fontSize == null ? FontSize(19.0) : FontSize(16.0),
